            ...
            $(function() {
                var table = $('#users-table').DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'employee_name', name: 'employees_tables.employee_name', width: '25%' },
                        { data: 'company_name', name: 'company_tables.name', width: '25%' },
                        { data: 'department_name', name: 'departments_tables.department_name', width: '25%' },
                        { data: 'store_name', name: 'stores_tables.name', width: '25%' },
                        { data: 'position_name', name: 'position_tables.name', width: '25%' },
                        { data: 'roles', name: 'roles', width: '25%' },
                ...
                function renderMobileCards() {
                    ...
                    data.each(function(user) {
                        var initials = user.employee_name ? user.employee_name.substring(0, 2).toUpperCase() : 'U';
                            ...
                            <table class="min-w-full divide-y divide-slate-700" id="users-table">
                                <thead class="bg-slate-900">
                                  <tr>
                                        <th class="text-center">Username</th>
                                        <th class="text-center">Employee Name</th>
                                        <th class="text-center">Comapany</th>
                                        <th class="text-center">Department</th>
                                        <th class="text-center">Location</th>
                                        <th class="text-center">Position</th>
                                        <th class="text-center">Roles</th>
