    ...
    @role('human')
            ...
            <div class="bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 rounded-2xl p-6 shadow-xl">
                ...
                <div class="mt-4 pt-4 border-t border-slate-700 space-y-3">
                    ...
                    @if ($ticket->notes_executor)
                        <div>
                            <p class="text-xs text-slate-500 mb-1">BD Notes</p>
        ...
        <div id="previewModalForExecutor" class="fixed inset-0 bg-black/80 hidden items-center justify-center p-4"
            ...
            <div class="bg-slate-900 rounded-2xl w-full max-w-3xl border border-slate-700 flex flex-col shadow-2xl"
                ...
                <div class="flex-1 overflow-hidden">
                    <iframe id="previewModalForExecutorIframe" src="" class="w-full" style="height:75vh;"
    ...
    <div class="px-4 space-y-6 pb-8 max-w-3xl mx-auto">
        ...
        @if ($ticket->review)
            <div class="bg-gradient-to-br from-green-900/20 to-emerald-900/20 border border-green-700/30 rounded-2xl p-6">
                ...
                <div class="bg-slate-900/50 rounded-xl p-4 space-y-3">
                    <div>
                        <p class="text-xs text-slate-500 mb-2">Ratings By : {{ $ticket->user->employee->employee_name }}
                        </p>
                        <div class="flex items-center space-x-2">
                            <div class="flex text-yellow-400 text-lg">
                                @for ($i = 1; $i <= 5; $i++)
                    ...
                    @if ($ticket->review->comment)
                        <div>
                            <p class="text-xs text-slate-500 mb-2">{{ $ticket->user->employee->employee_name }} Comment
                            </p>
                            <p class="text-sm text-slate-300 italic">"{{ $ticket->review->comment }}"</p>
                        </div>
                    @else
