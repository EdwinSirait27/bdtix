    ...
    <div class="px-4 space-y-6">
                ...
                <a href="#"
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <div class="text-sm text-white font-medium">
                                {{ Auth::user()->employee->department->first()?->department_name ?? ' +62 812-3456-9999' }}
                            </div>
                        </div>
                    </div>
        ...
        @if (count($user->all_roles_bdtix ?? []) > 1)
            <form method="POST" action="{{ route('profile.update-active-role') }}">
                ...
                <select name="role" id="active_role_bdtix"
                    class="mt-1 block w-full rounded-lg bg-slate-800 text-white p-2 border border-slate-700">
