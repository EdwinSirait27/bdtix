                    ...
                    <div class="block md:hidden space-y-3">
                        <div class="flex gap-2">
                            <div class="flex-1 relative">
                                <input type="text" id="mobile-search" placeholder="Search tickets exclude (employee name)"
                    ...
                    <div class="hidden md:block relative -mx-4 md:mx-0">
                        <div class="overflow-x-auto overflow-y-hidden w-full">
                            <div class="mb-4 flex flex-wrap items-center gap-3">
                                ...
                                <div class="flex flex-col gap-1">
                                    <label for="filterStatus" class="text-xs text-slate-300">Date From</label>
                                ...
                                <div class="flex flex-col gap-1">
                                    <label for="filterStatus" class="text-xs text-slate-300">*</label>
                                ...
                                <div class="w-full relative mt-2">
                                    ...
                                    <input type="text" id="table-search"
                                        placeholder="Search tickes (exclude employee name)"
            ...
            <div class="bg-slate-800 rounded-xl md:rounded-2xl shadow-lg border border-slate-700 overflow-hidden">
                ...
                <div class="px-4 py-4 md:px-6 md:py-5 border-b border-slate-700">
                    <div class="flex flex-col gap-3 md:gap-4">
                        <div>
                            <h2 class="text-lg md:text-xl font-bold text-white">Recent Tickets</h2>
