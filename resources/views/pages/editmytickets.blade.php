                ...
                <select id="store_id" name="store_id" required
                    ...
                    @forelse($stores as $store)
                        <option value="{{ $store->id }}"
                            {{ old('store_id', $ticket->store_id) === $store->id ? 'selected' : '' }}>
                            {{ $store->name }}
                        </option>
                    @empty
            ...
            <div>
                ...
                <div class="relative">
                    <select id="category" name="category" required
                        ...
                        <option value="Building" {{ old('category', $ticket->category) == 'Building' ? 'selected' : '' }}>
                            Building
                        </option>
                ...
                <div class="relative">
                    <select id="sub_category" name="sub_category" required
                        ...
                        <option value="Maintenance"
                            {{ old('sub_category', $ticket->sub_category) == 'Maintenance' ? 'selected' : '' }}>
                            Maintenance
                        </option>
...
@endif
        ...
        <form id="executor-attachments-form" action="{{ route('attachmentsforexecutor.store', $ticket->id) }}"
    ...
    <div id="userSourceModal" class="fixed inset-0 bg-black/70 hidden items-center justify-center z-50">
        <div class="bg-slate-900 rounded-xl p-6 w-80 text-center border border-slate-800">
            ...
            <button type="button" id="userCloseSource" class="w-full px-4 py-2 text-slate-400 hover:text-white">
                Abort
            </button>
        </div>
    </div>
