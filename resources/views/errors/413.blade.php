...
<head>
    ...
    <title>500 - Reuqest Entity too Large</title>
    <link rel="icon" type="image/png" href="https://cloud.asianbay.co.id/index.php/s/CHRczpYqozMHjoD/download">
                ...
                {{-- <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-600 to-cyan-500 flex items-center justify-center shadow-lg shadow-blue-500/30"> --}}
                    {{-- <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                                         ...
                                         <img src="https://cloud.asianbay.co.id/index.php/s/CHRczpYqozMHjoD/download"

                        class="w-15 h-15 select-none pointer-events-none" draggable="false" alt="icon">
                {{-- </div> --}}
                <div>
                    <h2 class="text-sm font-bold text-white">BD Departments</h2>
        ...
        <main class="flex-1 flex items-center justify-center px-6 py-12">
            <div class="text-center space-y-6 w-full">
                ...
                <div class="space-y-3 pt-6">
                    <h1 class="text-2xl font-bold text-white">File too Large</h1>
                    <p class="text-slate-400 text-sm leading-relaxed max-w-sm mx-auto">
compress your file first okay :).
                    </p>
                </div>
                ...
                <div class="bg-slate-800/50 border border-slate-700 rounded-2xl p-5 text-left space-y-3 backdrop-blur-sm">
                    ...
                    <ul class="space-y-2 text-sm text-slate-400">
                        ...
                        <li class="flex items-start space-x-2">
                            ...
                            <span>Compress your file first okayyy</span>
                        </li>
                    </ul>
                </div>
        ...
        <footer class="px-6 py-4 border-t border-slate-800 text-center">
                        <p class="text-xs text-slate-600"> &copy; 2025 BD SerTix, Developed by Edwin Sirait</p>
