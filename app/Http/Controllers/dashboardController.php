...
public function getAllticketforadmins(Request $request)
{
    ...
    return DataTables::eloquent($query)
        ...
        ->addColumn('action', function ($user) {
            ...
            return '
                <a href="' . route('editopenticket', $idHashed) . '" class="inline-flex items-center justify-center p-2 
                    text-slate-500 hover:text-indigo-600 hover:bg-indigo-50 rounded-full transition">
                    ✏️
                </a>
                <a href="' . route('showtickets', $idHashed) . '" class="inline-flex items-center justify-center p-2
                    text-slate-500 hover:text-emerald-600 hover:bg-emerald-50 rounded-full transition">
                    👁
                </a>
            ';
        })
